...
/* harmony default export */ __webpack_exports__["a"] = function(){
  ...
  element.innerHTML = "<div class='pure-menu pure-menu-horizontal'><a href='#' class='pure-menu-heading pure-menu-link'>BRAND</a><ul class='pure-menu-list'><li class='pure-menu-item'><a href='#' class='pure-menu-link'>News</a></li><li class='pure-menu-item'><a href='#' class='pure-menu-link'>Sports</a></li><li class='pure-menu-item'><a href='#' class='pure-menu-link'>Finance</a></li></ul></div>";
  return element;
};
...
// imports
exports.push([module.i, "@import url(https://unpkg.com/purecss@0.6.2/build/pure-min.css);", ""]);
